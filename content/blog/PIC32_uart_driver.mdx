...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The GitHub repo includes a more descriptive report of the project and all code including all uart functions, all register characters and packet buffer functions, and the programs main function. 
