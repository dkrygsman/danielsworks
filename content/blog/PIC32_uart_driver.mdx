...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The other functions of the Physical layer not featured above, but can be found in the Github repo include UartInit, Getchar, Putchar, and the none-package buffer functions.  
